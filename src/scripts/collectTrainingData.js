        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, generator.clearOldTrainingData(30)];
                case 1:
                    // Clear old training data (older than 30 days)
                    _a.sent();
                    console.log('Cleared old training data');
                    // Collect new training data
                    return [4 /*yield*/, generator.collectTrainingData(NICHES)];
                case 2:
                    // Collect new training data
                    _a.sent();
                ...
                case 3:
                    data = _a.sent();
                    viralCount = data.filter(function (d) { return d.isViral; }).length;
                    console.log("\nCollection Statistics:\n- Total samples: ".concat(data.length, "\n- Viral samples: ").concat(viralCount, "\n- Non-viral samples: ").concat(data.length - viralCount, "\n- Viral ratio: ").concat((viralCount / data.length * 100).toFixed(2), "%\n"));
                    return [2 /*return*/];
            }
        });
    });
